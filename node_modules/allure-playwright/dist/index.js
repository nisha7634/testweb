...
class AllureReporter {
    ...
    onStepBegin(test, _result, step) {
        ...
        const name = (_a = allureStep.wrappedItem) === null || _a === void 0 ? void 0 : _a.name;
        if (name === null || name === void 0 ? void 0 : name.match(stepAttachRegexp)) {
    ...
    async processAttachment(attachment, allureTest, runtime) {
        var _a, _b, _c, _d;
        ...
        if (name.match(diffEndRegexp)) {
            ...
            attachmentContext.addAttachment(diffName, { contentType: internal_1.ALLURE_IMAGEDIFF_CONTENT_TYPE }, res);
